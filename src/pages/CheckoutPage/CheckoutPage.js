...
export default function CheckoutPage() {
    ...
    function sentPurchase(e) {
        ...
        const products = cartItems.map((element) => ({ productAmout: Number(element.productAmout), productID: element.productID}))
        const body = { email: user.email, totalPrice: soma.toString(), address: form.address, product: products }
        console.log(body);
        ...
        <>
            ...
            <CheckoutContainer>
                ...
                <ProdutosCarrinho>
                    ...
                    {cartItems.map((product) => (<CartItems key={product.productID} product={product}></CartItems>))}
                    <Total>
                        <p> Total</p>
